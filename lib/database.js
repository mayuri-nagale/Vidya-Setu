const indexDefinitions = [
  ...
  ["doubts", { studentId: 1, lectureId: 1, lectureVersion: 1 }],
  ["doubts", { studentId: 1, clientSyncId: 1 }, { unique: true, partialFilterExpression: { clientSyncId: { $type: "string" } } }],
  ["downloads", { studentId: 1, fileId: 1 }, { unique: true }],
  ["downloads", { studentId: 1, lectureId: 1, lectureVersion: 1 }],
  ["quizAttempts", { studentId: 1, lectureId: 1 }, { unique: true }],
  ["quizAttempts", { teacherId: 1, lectureId: 1 }],
  ["quizAttempts", { studentId: 1, lectureId: 1, lectureVersion: 1 }],
  ["notifications", { eventKey: 1 }, { unique: true }],
  ["notifications", { recipientRole: 1, recipientId: 1, createdAt: -1 }],
  ["notifications", { createdAt: 1 }, { expireAfterSeconds: 24 * 60 * 60 }],
